...
def files(
    distribution_point: Annotated[str, typer.Option("--distribution-point", "-dp", help="An SCCM distribution point")],
    ...
    # Arguments format and coherence checks
    if not distribution_point.startswith('http://'):
    ...
    # Checking for Distribution Point anonymous access
